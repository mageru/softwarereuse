...
public class ib_FilterShadow extends ib_a_Ops {
	...
	public ib_FilterShadow() {
	}

	public ib_FilterShadow(float radius, float xOffset, float yOffset, float opacity) {
		this.radius = radius;
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
        ...
        shadow = new ib_FilterConvolveGaussian( radius ).filter( shadow, null );
