...
public abstract class ib_a_FilterTransform extends ib_a_Ops {
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
        ...
        if ( dst == null ) {
			...
			dst = new BufferedImage(dstCM, dstCM.createCompatibleWritableRaster((int)transformedSpace.width, (int)transformedSpace.height), dstCM.isAlphaPremultiplied(), null); //RPC
		}
	...
	protected BufferedImage filterPixelsNN( BufferedImage dst, int width, int height, int[] inPixels, ga_Rectangle transformedSpace ) {
		int srcWidth = width;
		int srcHeight = height;
		int outWidth = (int)transformedSpace.width; //RPC
		int outHeight = (int)transformedSpace.height;
