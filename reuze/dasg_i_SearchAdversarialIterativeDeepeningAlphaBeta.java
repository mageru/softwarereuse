 ...
 */
public class dasg_i_SearchAdversarialIterativeDeepeningAlphaBeta<STATE, ACTION, PLAYER>
	...
	public static <STATE, ACTION, PLAYER> dasg_i_SearchAdversarialIterativeDeepeningAlphaBeta<STATE, ACTION, PLAYER> createFor(
			dg_i_Game<STATE, ACTION, PLAYER> game, double utilMin, double utilMax,
			int time) {
		return new dasg_i_SearchAdversarialIterativeDeepeningAlphaBeta<STATE, ACTION, PLAYER>(
				game, utilMin, utilMax, time);
	}

	public dasg_i_SearchAdversarialIterativeDeepeningAlphaBeta(dg_i_Game<STATE, ACTION, PLAYER> game,
