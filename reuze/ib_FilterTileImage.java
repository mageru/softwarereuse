...
public class ib_FilterTileImage extends ib_a_Ops implements java.io.Serializable {
	...
	public ib_FilterTileImage() {
		this(32, 32);
	}

	public ib_FilterTileImage(int width, int height) {
		this.width = width;
		this.height = height;
	}
