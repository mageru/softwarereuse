...
public class s_SoundCipher extends s_SoundCipherUtilities implements ff_i_MIDIProgramChanges, ff_i_MIDIDrumMap, s_i_PitchClassSets, ff_MIDIMessageTypes {
 ...
 /**
	...
	*/
	...
	try {
	    InputStream is = vg_e_Processing.app.createInput(fileName);
	...
	try {
	     is = vg_e_Processing.app.createInput(fileName);
	...
	try {
	    clip = java.applet.Applet.newAudioClip(new java.net.URL ("file://" + vg_e_Processing.app.dataPath(fileLocation)));
	} catch (Exception e) {
	    e.printStackTrace();
	}
	return clip;
