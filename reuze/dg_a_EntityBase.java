...
import reuze.dg_StateMachine;
import reuze.dg_Telegram;
...
public abstract class dg_a_EntityBase implements Comparable<dg_a_EntityBase> {
	 ...
	 */
	public void setPosBy(double x, double y){
		pos.x += x;
		pos.y += y;
	}
	...
	public int compareTo(dg_a_EntityBase ga){
		if(ga != null)
			return entityID.compareTo(ga.entityID);
		else
