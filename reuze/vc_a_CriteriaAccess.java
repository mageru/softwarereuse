 ...
 */
public abstract class vc_a_CriteriaAccess implements Comparator<vc_e_Colors> {
    ...
    public abstract float getComponentValueFor(vc_e_Colors col);

    public abstract void setComponentValueFor(vc_e_Colors col, float value);//TODO
}
