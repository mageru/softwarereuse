 ...
 */
 public class ib_FilterLight extends ib_a_FilterWholeImage {
     ...
     */
      ...
      protected void setFromRGB( vc_Color4f c, int argb ) {
       ...
       protected int[] filterPixels( int width, int height, int[] inPixels, ga_Rectangle transformedSpace ) {
            ...
            vc_Color4f envColor = new vc_Color4f();
            vc_Color4f diffuseColor = new vc_Color4f( new Color(material.diffuseColor) );
            vc_Color4f specularColor = new vc_Color4f( new Color(material.specularColor) );
...
*/
                        ...
                        ib_FilterConvolveGaussian.convolveAndTranspose( kernel, bumpPixels, tmpPixels, bumpWidth, bumpHeight, true, false, false, ib_FilterConvolveGaussian.WRAP_EDGES );
                        ib_FilterConvolveGaussian.convolveAndTranspose( kernel, tmpPixels, softPixels, bumpHeight, bumpWidth, true, false, false, ib_FilterConvolveGaussian.WRAP_EDGES );
            ...
            for (int y = 0; y < height; y++) {
                  ...
                  for (int x = 0; x < width; x++) {
                        ...
                        if (normal.z >= 0) {
                              ...
                              // Shade the pixel
                              vc_Color4f c = phongShade(position, viewpoint, normal, diffuseColor, specularColor, material, lightsArray);
      ...
      protected vc_Color4f phongShade(gb_Vector3 position, gb_Vector3 viewpoint, gb_Vector3 normal, vc_Color4f diffuseColor, vc_Color4f specularColor, Material material, Light[] lightsArray) {
...
//                            rv = (float)Math.pow(rDotV, material.highlight);
      ...
      private int getEnvironmentMap(gb_Vector3 normal, int[] inPixels, int width, int height) {
            if (environmentMap != null) {
                  float angle = (float)Math.acos(-normal.y);

                  float x, y;
                  y = angle/m_MathUtils.PI;
                  ...
                  if (y == 0.0f || y == 1.0f)
                        ...
                        x = (float)Math.acos(f)/m_MathUtils.PI;
                  }
     ...
     */
       public static class Light implements Cloneable {
            ...
            int type = AMBIENT;
            gb_Vector3 position;
            gb_Vector3 direction;
            vc_Color4f realColor = new vc_Color4f();
            ...
            float coneAngle = m_MathUtils.PI/6;
            float cosConeAngle;
            float distance = 100.0f;

            public Light() {
                  this(270*m_MathUtils.PI/180.0f, 0.5235987755982988f, 1.0f);
            }
        ...
        /**
         * Set the center of the light in the X direction as a proportion of the image size.
        ...
        /**
         * Get the center of the light in the X direction as a proportion of the image size.
         * @return the center
         * @see #setCentreX
         */
         ...
         */
             public void prepare(int width, int height) {
                  ...
                  direction = new gb_Vector3(lx, ly, lz);
                  direction.nor();
                  if (type != DISTANT) {
                        lx *= distance;
                        ly *= distance;
                  ...
                  position = new gb_Vector3(lx, ly, lz);
