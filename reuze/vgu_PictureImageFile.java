...
public class vgu_PictureImageFile implements vg_i_Renderer {
	...
	public vgu_PictureImageFile(vg_e_Processing papp) {
		app = papp;
	}

	public vgu_PictureImageFile(vg_e_Processing papp, String path) {
		app = papp;
		image=app.loadImage(path);
	}

	public vgu_PictureImageFile(vg_e_Processing app2, String path, int x,
			int y, int w, int h) {
		app = app2;
