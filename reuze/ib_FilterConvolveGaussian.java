 ...
 */
public class ib_FilterConvolveGaussian extends ib_FilterConvolve {
	 ...
	 */
	public ib_FilterConvolveGaussian() {
		this(2);
	}
	 ...
	 */
	public ib_FilterConvolveGaussian(float radius) {
		setRadius(radius);
	}
	...
	public static Kernel makeKernel(float radius) {
		...
		float sigmaPi2 = m_MathUtils.TWO_PI*sigma;
