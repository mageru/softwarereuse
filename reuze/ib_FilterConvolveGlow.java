 ...
 */
public class ib_FilterConvolveGlow extends ib_FilterConvolveGaussian {

	static final long serialVersionUID = 5377089073023183684L;

	private float amount = 0.5f;
	
	public ib_FilterConvolveGlow() {
		radius = 2;
	}
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
		...
		for ( int y = 0; y < height; y++ ) {
			for ( int x = 0; x < width; x++ ) {
				...
				r1 = m_MathUtils.clampToByte( (int)(r1 + a * r2) );
				g1 = m_MathUtils.clampToByte( (int)(g1 + a * g2) );
				b1 = m_MathUtils.clampToByte( (int)(b1 + a * b2) );
