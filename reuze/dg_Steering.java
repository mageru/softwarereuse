...
public class dg_Steering implements Cloneable, dg_i_SteeringConstants{
	...
	/**
	 * Sets the radius for the group behaviours (separation, alignment and cohesion)
	 * 
	 ...
	 * @param deltaTime time since lst update in seconds
...
//		return flee();
	 ...
	 * @param behavior the behavior or behaviours we are interested in.
