...
import reuze.m_i_InterpolateValue;
import reuze.m_ScaleMap;
...
public class vc_ToneMap {
    ...
    public vc_ToneMap(float a, float b, vc_e_Colors colA, vc_e_Colors colB) {
        this(a, b, new vc_ColorList(colA, colB));
    }

    public vc_ToneMap(float min, float max, vc_e_Colors colA,
            vc_e_Colors colB, int res) {
    ...
    public final vc_e_Colors getToneFor(float t) {
        int idx;
        if (colors.size() > 2) {
