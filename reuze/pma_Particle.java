...
public class pma_Particle {
    ...
    public pma_Particle(double rx, double ry, double vx, double vy, double radius, double mass, Color color) {
        this.vx = vx;
        this.vy = vy;
        this.rx = rx;
        this.ry = ry;
    ...
    // draw the particle
    public void draw() {
        vgu_StdDraw.setPenColor(color);
        vgu_StdDraw.filledCircle(rx, ry, radius);
    }
