...
public class ib_FilterSky extends ib_a_FilterPoint {
	...
	public ib_FilterSky() {}
	public ib_FilterSky(BufferedImage skyColor) {
		skyColors = skyColor;
	}
...
//		g.dispose();
	...
	public float evaluate(float x, float y) {
		...
		for (i = 0; i < (int)octaves; i++) {
			value += m_Noise.noise3(x, y, t) * exponents[i];
			x *= lacunarity;
			y *= lacunarity;
		}
		...
		if (remainder != 0)
			value += remainder * m_Noise.noise3(x, y, t) * exponents[i];
