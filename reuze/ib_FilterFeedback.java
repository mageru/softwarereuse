...
public class ib_FilterFeedback extends ib_a_Ops {
    ...
    public ib_FilterFeedback() {
	}
	
	public ib_FilterFeedback( float distance, float angle, float rotation, float zoom ) {
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
        ...
        for ( int i = 0; i < iterations; i++ ) {
			...
			g.setComposite( AlphaComposite.getInstance( AlphaComposite.SRC_OVER, m_InterpolateLerp.lerp( (float)i/(iterations-1), startAlpha, endAlpha ) ) );
