 ...
 */
public class vgu_e_ToxiclibsSupport {

    protected static final Logger logger = Logger
            .getLogger(vgu_e_ToxiclibsSupport.class.getName());
    ...
    public vgu_e_ToxiclibsSupport(PApplet app) {
        this(app, app.g);
    }

    public vgu_e_ToxiclibsSupport(PApplet app, PGraphics gfx) {
        this.app = app;
        this.gfx = gfx;
    }
    ...
    public final void strokeFill(boolean isWireframe, vc_e_Colors stroke, vc_e_Colors fill) {
        if (isWireframe) {
            gfx.noFill();
