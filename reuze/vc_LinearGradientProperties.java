...
//	@XmlAttribute
	...
	public static void getGradients(ArrayList<vc_GradientStopProperties> stopList, float[] f /*inout*/, Color[] c /*inout*/) {
		for (int i = 0; i < stopList.size(); i++) {
          	 ...
          	 if (eel.style!=null) {
             	 ...
             	 c[i]=vc_ColorNames.getColor(s.stopColor, s.stopOpacity);
          	 } else c[i]=vc_ColorNames.getColor(eel.color, eel.opacity);
       }
	}
