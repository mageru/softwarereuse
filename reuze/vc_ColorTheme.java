...
public class vc_ColorTheme {
    ...
    static class ThemePart {
        ...
        ThemePart(vc_ColorRange range, vc_e_Colors col, float weight) {
            this.range = range;
            this.col = col;
            this.weight = weight;
        }
    ...
    public vc_ColorTheme addRange(vc_ColorRange range, vc_e_Colors col,
            float weight) {
    ...
    public vc_ColorTheme addRange(String descriptor, float weight) {
        ...
        while (st.hasMoreTokens()) {
            ...
            } else if (vc_e_Colors.getColor(item) != null) {
                col = vc_e_Colors.getColor(item);
            }
        }
        if (range != null) {
    ...
    /**
     * Creates a {@link vc_ColorList} of {@link vc_e_Colors}s based on the theme's
