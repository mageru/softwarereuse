 ...
 */
public class ib_FilterBorder extends ib_a_Ops {

	private int leftBorder, rightBorder;
	private int topBorder, bottomBorder;
	private Paint borderPaint;

	public ib_FilterBorder() {
	}

	public ib_FilterBorder( int leftBorder, int topBorder, int rightBorder, int bottomBorder, Paint borderPaint ) {
