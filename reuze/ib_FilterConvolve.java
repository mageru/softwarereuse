 ...
 */
 public class ib_FilterConvolve extends ib_a_Ops {
     ...
     */
       ...
       */
       public ib_FilterConvolve(float[] matrix) {
       ...
       */
       public ib_FilterConvolve(int rows, int cols, float[] matrix) {
       ...
       */
       public ib_FilterConvolve(Kernel kernel) {
            this.kernel = kernel;   
      }
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
        ...
        if ( premultiplyAlpha )
        	i_MathImageUtils.unpremultiply( outPixels, 0, outPixels.length );
       ...
       public static void convolveHV(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha, int edgeAction) {
            ...
            for (int y = 0; y < height; y++) {
                  for (int x = 0; x < width; x++) {
                        ...
                        int ia = alpha ? m_MathUtils.clampToByte((int)(a+0.5)) : 0xff;
                        int ir = m_MathUtils.clampToByte((int)(r+0.5));
                        int ig = m_MathUtils.clampToByte((int)(g+0.5));
                        int ib = m_MathUtils.clampToByte((int)(b+0.5));
