...
public class m_NoisePerlin implements m_i_Noise {
	...
	public float setParameter(String name, float value) {
		float old;
		if (name.charAt(0)=='s') {old=seed; noiseSeed(value);}
		else if (name.charAt(0)=='l') {old=perlin_octaves; noiseDetail((int)value);}
		else {old=perlin_amp_falloff; noiseDetail(value);}
		return old;
	}
