...
public class ib_GraphTiled {
	 ...
	 */
	public static void makeGraphFromBWimage(dag_GraphFloatingEdges g, BufferedImage backImg, BufferedImage costImg, int tilesX, int tilesY, boolean allowDiagonals) {
