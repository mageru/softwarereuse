...
public class vg_PathProperties implements da_i_Validate {
	...
	private static char getPathFloat(StringTokenizer t, d_FloatRef f) {
	...
	public static final void arcTo(GeneralPath path, float rx, float ry, float theta, boolean largeArcFlag, boolean sweepFlag, float x, float y) {
		...
		java.awt.geom.Point2D p2d = path.getCurrentPoint();
