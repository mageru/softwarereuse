...
public class vgu_SpritePS implements vg_i_Sprite, vg_i_SpriteBatch {
	float x,y,width,height, scale;
	int color, shape, blend;
	PImage texture;
	float rotateRadians;
	boolean flipX, flipY;
	public static vgu_e_ToxiclibsSupport g;
	public vgu_SpritePS() {
		
	}
    public vgu_SpritePS(vgu_SpritePS awt) {
