 ...
 * rules for new {@link vc_e_Colors}s or {@link vc_ColorList}s. The class comes with 11
...
public class vc_ColorRange {
     ...
     *            base color
     */
    public vc_ColorRange(vc_e_Colors c) {
     ...
     * @return itself
     */
    public vc_ColorRange add(vc_e_Colors c) {
     ...
     */
    public boolean contains(vc_e_Colors c) {
     ...
     * @return copy
     */
    public vc_ColorRange copy(vc_e_Colors c, float variance) {
     ...
     * @return color
     */
    public vc_e_Colors getColor(vc_e_Colors c, float variance) {
        float h, s, b, a;
        if (c != null) {
            if (c.isBlack()) {
                return vc_e_Colors
        ...
        return vc_e_Colors.newHSVA(h, s, b, a);
    }
    ...
    /**
     * Creates a new {@link vc_ColorList} of shades of the given {@link vc_e_Colors}
     ...
     * @return color list
     */
    public vc_ColorList getColors(vc_e_Colors c, int num, float variance) {
     ...
     */
    public vc_e_Colors getGrayscale(float brightness, float variance) {
        return getColor(vc_e_Colors.newGray(brightness), variance);
    }
