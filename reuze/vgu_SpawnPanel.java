...
class vgu_SpawnPanel extends vgu_EditorPanel {
	...
	public vgu_SpawnPanel (final dg_ParticleEmitter.SpawnShapeValue spawnShapeValue, final vgu_ParticleEditor editor) {
		super("Spawn", null);
	...
	public void update (vgu_ParticleEditor editor) {
