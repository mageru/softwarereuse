...
public abstract class vc_RGBComposite implements Composite {

	protected float extraAlpha;

	public vc_RGBComposite() {
		this( 1.0f );
	}

	public vc_RGBComposite( float alpha ) {
	...
	public boolean equals(Object o) {
		if (!(o instanceof vc_RGBComposite))
			return false;
		vc_RGBComposite c = (vc_RGBComposite)o;
