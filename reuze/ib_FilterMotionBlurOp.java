...
public class ib_FilterMotionBlurOp extends ib_a_Ops {
    ...
    public ib_FilterMotionBlurOp() {
	}
	
	public ib_FilterMotionBlurOp( float distance, float angle, float rotation, float zoom ) {
