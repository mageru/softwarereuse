...
/**
 * This class that models the behavior of a moving entity that is not acting under
...
public class dg_EntityMover extends dg_a_EntityBase {
	...
	public void update(double deltaTime, dg_World world) {
		...
		// Update position
		pos = new ga_Vector2D(pos.x + velocity.x * deltaTime, pos.y + velocity.y * deltaTime);
