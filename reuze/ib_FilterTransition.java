 ...
 */
public class ib_FilterTransition extends ib_a_Ops {
	...
	private ib_FilterTransition() {
	}

	public ib_FilterTransition( BufferedImageOp filter, String property, float minValue, float maxValue ) {
		this.filter = filter;
